    ...
    <div className="ofertaCarousel">
      ...
      <Carousel className='offCarousel'>
        ...
        <Carousel.Item className='itemCarousel'>
          <div className="row justify-content-center">
            <div className="col-md-3">
              <Link to="/item/1"> {/* Redirige a la página del artículo con id=1 */}
            ...
            <div className="col-md-3">
              <Link to="/item/8"> {/* Redirige a la página del artículo con id=2 */}
            ...
            <div className="col-md-3">
              <Link to="/item/7"> {/* Redirige a la página del artículo con id=3 */}
            ...
            <div className="col-md-3">
              <Link to="/item/4"> {/* Redirige a la página del artículo con id=4 */}
        ...
        <Carousel.Item className='itemCarousel'>
          <div className="row justify-content-center">
            <div className="col-md-3">
              <Link to="/item/5"> {/* Redirige a la página del artículo con id=5 */}
            ...
            <div className="col-md-3">
              <Link to="/item/6"> {/* Redirige a la página del artículo con id=6 */}
            ...
            <div className="col-md-3">
              <Link to="/item/7"> {/* Redirige a la página del artículo con id=7 */}
            ...
            <div className="col-md-3">
              <Link to="/item/11"> {/* Redirige a la página del artículo con id=8 */}
